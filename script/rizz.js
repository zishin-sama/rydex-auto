...
module.exports.config = {
    name: "rizz",
    author: "Vex_Kshitiz",//converted by chilli
    description: { en: "Rizz the girls in a different way" },
    commandCategory: "fun",
    cooldown: 10,
    credits: "Vex_Kshitiz",
    usages: "[mention]",
...
module.exports.run = async function ({ api, event, args }) {
    try {
        ...
        const imagePath = await generateImage(one, two, mentionName);
...
async function generateImage(one, two, mentionName) {
    try {
        ...
        const imagePath = path.join(__dirname, "rizz.png");
