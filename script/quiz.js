module.exports.config = {
  name: "quiz",
  version: "1.0",// just found in my 
  role: 0,       // notes app 
  credits: "Aki Hayakawa", // i saved 
  aliases: [],//raw codes shared by devs
  usage: "quiz [difficulty] [category]/ quiz help", // through pastebin 
  hasPrefix: true, // credits to
  description: "Answer trivia questions", // the owner
  cooldown: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  try {
    ...
    if (args[0] == 'help'){
      return api.sendMessage(`Azenou\'s Quiz\n\nDifficulties:\n\neasy\nmedium\nhard\n\nCategories:\n\ngeneral\nbooks\nfilm\nmusic\ntheatres\ntelevision\nvideogames\nboardgames\nscience\ncomputers\nmath\nmythology\nsports\ngeography\nhistory\npolitics\nart\ncelebrity\nanimals\nvehicles\ncomics\ngadgets\nanime\ncartoon\n\nUsage:\n${PREFIX}quiz [difficulty] [category]\n\nExample:\n${prefix}quiz medium math`, threadID, messageID);
    }
